...
df_13 = pd.read_parquet("../combined_dataset_v0.13.parquet", columns=['source_laundering_score', 'target_laundering_score'])
...
# df = pd.read_parquet("../combined_dataset_v0.2.parquet")
# print(df.head())
